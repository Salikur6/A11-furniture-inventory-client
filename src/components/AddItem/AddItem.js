    ...
    return (
        <div>
            ...
            <form className='w-50 mx-auto my-5' onSubmit={handleSubmit(onSubmit)}>
                <input type="text" className='form-control mb-2' placeholder="name" {...register("name", { required: true, maxLength: 80 })} />
                <input type="email" className='form-control mb-2' placeholder="email" {...register("email", { required: true, pattern: /^\S+@\S+$/i })} />
